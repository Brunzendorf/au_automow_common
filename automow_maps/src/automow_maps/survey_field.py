...
class RenderArea(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.easting_offset = rospy.get_param('/magellan_dg14/easting_offset', 0)
        self.northing_offset = rospy.get_param('/magellan_dg14/northing_offset', 0)
    ...
    def draw_gps_points(self, painter):
